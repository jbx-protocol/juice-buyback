...
contract TestJBBuybackDelegate_Fork is Test, UniswapV3ForgeQuoter {
  ...
  function setUp() public {
    ...
    jbController = IJBController3_1(
      stdJson.readAddress(
        vm.readFile(
          'node_modules/@jbx-protocol/juice-contracts-v3/deployments/mainnet/JBController3_1.json'
        ),
        '.address'
      )
    );
    ...
    jbTerminalStore = IJBSingleTokenPaymentTerminalStore(
  ...
  function test_mintIfWeightGreatherThanPrice(uint256 _weight) public {
    ...
    assertApproxEqAbs(
      ...
      _reservedBalanceBefore + _weight / 2,
      1
    );
  }
  ...
  function test_swapIfQuoteBetter(uint256 _weight) public {
    ...
    assertApproxEqAbs(
      jbController.reservedTokenBalanceOf(1),
      _reservedBalanceBefore + amountOutForOneEth / 2,
      1
    );
  }
  ...
  function test_swapMultiple() public {
    ...
    assertApproxEqAbs(
      jbController.reservedTokenBalanceOf(1),
      _reserveBalance + amountOutForOneEth / 2,
      1
    );
  }
  ...
  function test_swapWhenQuoteNotProvidedInMetadataAndWhenRefundHappensAfterTheSwap() public {
    ...
    assertEq(
      _balanceAftereSweepingLeftOverFunds - _balanceBeforeSweepingLeftOverFunds,
      _currentSweepBalance
    );
  }
  ...
  function _reconfigure(
    ...
    _groupedSplits[0] = JBGroupedSplits({
      ...
      splits: jbSplitsStore.splitsOf(
        ...
        /*domain*/ JBSplitsGroups.ETH_PAYOUT /*group*/
      )
    });
