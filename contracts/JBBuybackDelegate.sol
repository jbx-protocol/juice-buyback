  ...
  IUniswapV3SwapCallback
{
  ...
  function uniswapV3SwapCallback(
    ...
    uint256 _amountToSendToPool = PROJECT_TOKEN_IS_TOKEN0
      ? uint256(amount1Delta)
      : uint256(amount0Delta);
    uint256 _amountReceivedForBeneficiary = PROJECT_TOKEN_IS_TOKEN0
      ? uint256(-amount0Delta)
      : uint256(-amount1Delta);
  ...
  function _swap(
    ...
    try
      POOL.swap({
        ...
        sqrtPriceLimitX96: PROJECT_TOKEN_IS_TOKEN0
